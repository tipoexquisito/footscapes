...
**`git add -A`**
Marca todas as alterações que fizeste (ficheiros novos, editados ou apagados) para irem no próximo envio. O "-A" quer dizer "all", tudo. Não envia nada ainda, só prepara.
